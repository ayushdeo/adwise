...
- **contrast-consistency (judge acc on HARD kinds): 0.667**  (target >=0.85)
- keyword acc on HARD kinds: 0.000  (target <=0.60 — should FAIL)
- overall acc: judge 0.800 | keyword 0.400

## Failure modes on the hard kinds
- keyword FALSE-POSITIVE on benign-with-tokens: 1.00  (judge: 0.00)
- keyword FALSE-NEGATIVE on manip-without-tokens: 1.00  (judge: 0.67)
